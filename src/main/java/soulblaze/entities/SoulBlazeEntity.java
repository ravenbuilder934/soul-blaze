...
public class SoulBlazeEntity extends MonsterEntity
{
    private static final DataParameter<Byte> ON_FIRE = EntityDataManager.createKey(SoulBlazeEntity.class, DataSerializers.BYTE);
    private float heightOffset = 0.5F;
    private int heightOffsetUpdateTime;

    public SoulBlazeEntity(EntityType<? extends SoulBlazeEntity> type, World world)
    {
        super(type, world);
    ...
    {
        this.goalSelector.addGoal(4, new SoulBlazeEntity.FireballAttackGoal(this));
    ...
    static class FireballAttackGoal extends Goal
    {
        ...
        public FireballAttackGoal(SoulBlazeEntity blazeIn)
        {
            this.blaze = blazeIn;
